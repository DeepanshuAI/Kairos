...
export const CAMERA_STAGES: CameraKeyframe[] = [
  ...
  },
  {
    ...
    target: [1, 2, 0],
    label: 'STAGE 01 — LIGHT',
    sublabel: 'DAWN TO DUSK',
  },
  {
    pos: [9, 5, 11],
    target: [2, 3, 0],
    label: 'STAGE 02 — MATERIAL',
  ...
  },
  {
    ...
    target: [1, 2.2, 0],
    label: 'STAGE 02 — MATERIAL',
    sublabel: 'TACTILE CONCRETE',
  },
  {
    pos: [0.5, 2.2, 1.8],
    target: [-1, 2.2, -1],
    label: 'STAGE 03 — SPACE',
  ...
  },
  {
    ...
    target: [2, 2.5, 0],
    label: 'STAGE 03 — SPACE',
    sublabel: 'UNINTERRUPTED HORIZON',
  },
  {
    pos: [20, 10, 20],
    target: [0, 2, 0],
    label: 'STAGE 04 — FULL EXPERIENCE',
